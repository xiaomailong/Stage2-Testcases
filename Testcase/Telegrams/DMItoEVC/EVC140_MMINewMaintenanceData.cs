                    ...
                    _pool.TraceError(string.Format("{0}:", BaseString) + Environment.NewLine +
                                     ((_mdDataset == Variables.MMI_Q_MD_DATASET.WheelDiameter)
                                         ? string.Format("MMI_M_WHEEL_SIZE_1 = {0} ",
                                               _pool.SITR.CCUO.ETCS1NewMaintenanceData.MmiMSduWheelSize1) +
                                           Environment.NewLine +
                                           string.Format("MMI_M_WHEEL_SIZE_2 = {0} ",
                                               _pool.SITR.CCUO.ETCS1NewMaintenanceData.MmiMSduWheelSize2) +
                                           Environment.NewLine +
                                           string.Format("MMI_M_WHEEL_SIZE_ERR = {0} ",
                                               _pool.SITR.CCUO.ETCS1NewMaintenanceData.MmiMWheelSizeErr)
                                         : string.Format("MMI_M_PULSE_PER_KM_1 = {0} ",
                                               _pool.SITR.CCUO.ETCS1NewMaintenanceData.MmiMPulsePerKm1) +
                                           Environment.NewLine +
                                           string.Format("MMI_M_PULSE_PER_KM_2 = {0} ",
                                               _pool.SITR.CCUO.ETCS1NewMaintenanceData.MmiMPulsePerKm2)
                                     ) +
