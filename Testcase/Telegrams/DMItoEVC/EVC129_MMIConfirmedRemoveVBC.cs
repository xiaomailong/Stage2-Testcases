...
namespace Testcase.Telegrams.DMItoEVC
{
    ...
    /// </summary>
    public static class EVC129_MMIConfirmedRemoveVBC
    {
        ...
        private static void CheckVBCCode()
        {
            ...
            if (_pool.SITR.SMDStat.CCUO.ETCS1ConfirmedRemoveVbc.WaitForCondition(Is.Equal, 1, 20000, 100))
            {
                ...
                {
                    _pool.TraceError($"{BaseString} - MMI_M_VBC_CODE_ = " + _pool.SITR.CCUO.ETCS1ConfirmedRemoveVbc.MmiMVbcCodeR.Value +
