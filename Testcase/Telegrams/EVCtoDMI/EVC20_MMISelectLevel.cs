...
namespace Testcase.Telegrams.EVCtoDMI
{
    ...
    /// This packet shall be sent when the ETC requests the driver to select level. The packet contains a list of ETCS and NTC levels and 
    /// related additional status information. Possible use cases are display of 'default level list', display of 'trackside supported level list',
    ...
    public static class EVC20_MMISelectLevel
    {
        ...
        /// <summary>
        /// Initialise EVC-20 MMI Current RBC Data telegram
        /// </summary>
        ...
        /// <summary>
        /// Send EVC-20 MMI Current RBC Data telegram
        /// </summary>
