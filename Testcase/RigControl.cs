...
namespace Testcase
{
    static class RigControl
    {
        ...
        {
            var shutdown = (int)pool.SITR.Client.Read("SCT1_MCS_Shutdown");
            var forward = (int)pool.SITR.Client.Read("SCT1_MCS_Forward");
            var secure = (int)pool.SITR.Client.Read("SCT1_MCS_Secure");
            var recovery = (int)pool.SITR.Client.Read("SCT1_MCS_Recovery");
            var reverse = (int)pool.SITR.Client.Read("SCT1_MCS_Reverse");
            var keyswitch = (int)pool.SITR.Client.Read("SCT1_MCS_KeySwitch");
        ...
        {
            var shutdown = (int)pool.SITR.Client.Read("SCT2_MCS_Shutdown");
            var forward = (int)pool.SITR.Client.Read("SCT2_MCS_Forward");
            var secure = (int)pool.SITR.Client.Read("SCT2_MCS_Secure");
            var recovery = (int)pool.SITR.Client.Read("SCT2_MCS_Recovery");
            var reverse = (int)pool.SITR.Client.Read("SCT2_MCS_Reverse");
            var keyswitch = (int)pool.SITR.Client.Read("SCT2_MCS_KeySwitch");
