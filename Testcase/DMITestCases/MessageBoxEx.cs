...
namespace System.Windows.Forms
{
	public class MessageBoxEx
	{
        ...
        public static bool WaitForVerificationTimeout(string test, uint timeout)
        {
            Cancelled = false;
            DialogResult result = Show(test, "Check the following", MessageBoxButtons.YesNo, timeout);
