    ...
    public class TC_ID_10_4_1_4_State_ST05 : TestcaseBase
    {
        ...
        private void XML_10_4_1_4_a_b(msgType type)
        {
            ...
            else if (type == msgType.typeb)
            {
                ...
                //EVC24_MMISystemInfo.MMI_M_LEVEL_INSTALLED = 248;
