        ...
        private void XML_12_5_4(msgType type)
        {
            ...
            switch (type)
            {
                ...
                case msgType.typef:
                    ...
                    SITR.ETCS1.EtcsMiscOutSignals.EVC7Validity1.Value = 0xfc88; // Bit-reverse of 4415 as set by xml file
                    SITR.ETCS1.EtcsMiscOutSignals.EVC7Validity2.Value = 0xfc00; // Bit-reverse of 63 as set by xml file
