...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_12_2_Train_Speed : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            DmiActions.ShowInstruction(this, "Power down the system and reconfigure speed dial properties, then power up the system:" + Environment.NewLine +
                                             "SPEED_UNIT_TYPE = 0, SPEED_UNIT_DISPLAY = 0, SPEED_DIAL_V_MAX = 250, SPEED_DIAL_V_TRANS = 100, " + Environment.NewLine +
                                             "SPEED_DIAL_V_NUMBER1 = 20, SPEED_DIAL_V_NUMBER2 = 20, SPEED_DIAL_N_SHORT_LINES1 = 1, SPEED_DIAL_N_SHORT_LINES2 = 0, SPEED_DIAL_N_LONG_LINES1 = 0, " + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, "Power down the system and reconfigure speed dial properties, then power up the system:" + Environment.NewLine +
                                             "SPEED_UNIT_TYPE = 0, SPEED_UNIT_DISPLAY = 0, SPEED_DIAL_V_MAX = 180, SPEED_DIAL_V_TRANS = 0, " + Environment.NewLine +
                                             "SPEED_DIAL_V_NUMBER1 = 20, SPEED_DIAL_V_NUMBER2 = 0, SPEED_DIAL_N_SHORT_LINES1 = 1, SPEED_DIAL_N_SHORT_LINES2 = 0, SPEED_DIAL_N_LONG_LINES1 = 0, " + Environment.NewLine +
                                             "SPEED_DIAL_N_LONG_LINES2 = 0, SPEED_DIAL_ANGLE_V_0 = -144, SPEED_DIAL_ANGLE_V_TRANS = 0, SPEED_DIAL_ANGLE_V_MAX = 144");
            ...
            */
            DmiActions.ShowInstruction(this, "Power down the system and reconfigure speed dial properties, then power up the system:" + Environment.NewLine +
                                             "SPEED_UNIT_TYPE = 0, SPEED_UNIT_DISPLAY = 0, SPEED_DIAL_V_MAX = 140, SPEED_DIAL_V_TRANS = 0, " + Environment.NewLine +
                                             "SPEED_DIAL_V_NUMBER1 = 20, SPEED_DIAL_V_NUMBER2 = 0, SPEED_DIAL_N_SHORT_LINES1 = 1, SPEED_DIAL_N_SHORT_LINES2 = 0, SPEED_DIAL_N_LONG_LINES1 = 0, " + Environment.NewLine +
                                             "SPEED_DIAL_N_LONG_LINES2 = 0, SPEED_DIAL_ANGLE_V_0 = -144, SPEED_DIAL_ANGLE_V_TRANS = 0, SPEED_DIAL_ANGLE_V_MAX = 144");
            ...
            */
            DmiActions.ShowInstruction(this, "Power down the system and reconfigure speed dial properties, then power up the system:" + Environment.NewLine +
                                             "SPEED_UNIT_TYPE = 0, SPEED_UNIT_DISPLAY = 1, SPEED_DIAL_V_MAX = 140, SPEED_DIAL_V_TRANS = 0, " + Environment.NewLine +
                                             "SPEED_DIAL_V_NUMBER1 = 20, SPEED_DIAL_V_NUMBER2 = 0, SPEED_DIAL_N_SHORT_LINES1 = 1, SPEED_DIAL_N_SHORT_LINES2 = 0, SPEED_DIAL_N_LONG_LINES1 = 0, " + Environment.NewLine +
                                             "SPEED_DIAL_N_LONG_LINES2 = 0, SPEED_DIAL_ANGLE_V_0 = -144, SPEED_DIAL_ANGLE_V_TRANS = 0, SPEED_DIAL_ANGLE_V_MAX = 144");
