        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            WaitForVerification("Close the main window and check the following" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. Speed Dial has a circular border and indicates a speed scale from 0 km/h to 400km/h." + Environment.NewLine +
                                "3. The speed indicator numbers and lines are in white." + Environment.NewLine +
                                "4. Speed Dial has short and long lines drawn radially from the limit of sub-area B0 towards the center of sub-area B0 at every 10km/h." + Environment.NewLine +
                                "5. No speed unit is beneath the speed pointer’s hub." + Environment.NewLine +
            ...
            */
            ...
            WaitForVerification("Close the main window and check the following" + Environment.NewLine + Environment.NewLine +
                                "1. Speed Dial is displayed in sub-area B0." + Environment.NewLine +
                                "2. Speed Dial has a circular border and indicates a speed scale from 0 km/h to 250km/h." + Environment.NewLine +
                                "3. The speed indicator numbers and lines are in white." + Environment.NewLine +
                                "4. Speed Dial has short and long lines drawn radially from the limit of sub-area B0 towards the center of sub-area B0 at every 10km/h." + Environment.NewLine +
                                "5. No speed unit is beneath the speed pointer’s hub." + Environment.NewLine +
                                "6. The scaling numbers are positioned at the end of the related indicator line towards the centre of B0.");
            ...
            */
            ...
            WaitForVerification("Close the main window and check the following" + Environment.NewLine + Environment.NewLine +
                                "1. Speed Dial is displayed in sub-area B0." + Environment.NewLine +
                                "2. Speed Dial has a circular border and indicates a speed scale from 0 km/h to 180km/h." + Environment.NewLine +
                                "3. The speed indicator numbers and lines are in white." + Environment.NewLine +
                                "4. Speed Dial has short and long lines drawn radially from the limit of sub-area B0 towards the center of sub-area B0 at every 10km/h." + Environment.NewLine +
                                "5. No speed unit is beneath the speed pointer’s hub." + Environment.NewLine +
                                "6. The scaling numbers are positioned at the end of the related indicator line towards the centre of B0.");
            ...
            */
            ...
            WaitForVerification("Close the main window and check the following" + Environment.NewLine + Environment.NewLine +
                                "1. Speed Dial is displayed in sub-area B0." + Environment.NewLine +
                                "2. Speed Dial has a circular border and indicates a speed scale from 0 km/h to 140km/h." + Environment.NewLine +
                                "3. The speed indicator numbers and lines are in white." + Environment.NewLine +
                                "4. Speed Dial has short and long lines drawn radially from the limit of sub-area B0 towards the center of sub-area B0 at every 10km/h." + Environment.NewLine +
                                "5. No speed unit is beneath the speed pointer’s hub." + Environment.NewLine +
                                "6. The scaling numbers are positioned at the end of the related indicator line towards the centre of B0.");
