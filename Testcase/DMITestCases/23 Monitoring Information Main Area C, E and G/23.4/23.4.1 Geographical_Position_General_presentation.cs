...
namespace Testcase.DMITestCases
{
    ...
    public class Geographical_Position_General_presentation : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            // Call generic Action Method
            DmiActions.ShowInstruction(@"Press on the ‘DR03’ symbol, on sub-area G12 to toggle on the Geographical Position function and verify the presentation on the screen");
            ...
            */
            // Call generic Action Method
            DmiActions.ShowInstruction(@"Press on the ‘DR03’ symbol on sub-area G12 to toggle off the Geographical Position function and verify the presentation on the screen");
