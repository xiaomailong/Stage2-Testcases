    ...
    public class TC_ID_36_3_3_Restrictive_Target_with_Speed_Monitoring_in_Limited_Supervision_Mode : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Drive the train forward pass BG1.Then, press an LS mode acknowledgement on sub-area C1");
            TraceReport("Expected Result");
            TraceInfo("ETCS OB enters LS mode in Level 1");
            /*
            Test Step 3
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Continue to drive the train forward with constant speed at 20 km/h");
            TraceReport("Expected Result");
            TraceInfo(
