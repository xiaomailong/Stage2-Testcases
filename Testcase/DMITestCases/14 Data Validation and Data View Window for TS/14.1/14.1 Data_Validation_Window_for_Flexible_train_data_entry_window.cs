...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_9_1_Data_Validation_Window : TestcaseBase
    {
        public override void PreExecution()
        {
            ...
            // Open defaultValues_default.xml in OTE  then set all value of parameter "  TR_OBU_TrainType" to 2 System is powered ON.Cabin is activated.SoM is performed until Level 1 is selected and confirmed.Train data window is opened.
