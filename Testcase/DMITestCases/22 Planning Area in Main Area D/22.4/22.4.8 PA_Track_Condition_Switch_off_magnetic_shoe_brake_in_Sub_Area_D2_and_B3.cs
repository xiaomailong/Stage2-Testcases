    ...
    public class TC_ID_17_4_8_PA_Track_Condition_Switch_off_magnetic_shoe_brake_in_Sub_Area_D2_and_B3 : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “Switch off magnetic shoe brake”");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC13 or TC14 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
