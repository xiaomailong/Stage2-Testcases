    ...
    public class TC_ID_17_4_14_PA_Track_Condition_Change_of_traction_system_DC_1_5_kV_Sub_Area_D2_and_B3 : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “Change of traction system, DC 1.5 kV”");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC31 or TC32 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
