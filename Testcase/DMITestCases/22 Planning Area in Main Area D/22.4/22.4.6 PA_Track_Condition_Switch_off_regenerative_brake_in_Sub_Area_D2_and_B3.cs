    ...
    public class TC_ID_4_6_PA_Track_Condition_Switch_off_regenerative_brake_in_Sub_Area_D2_and_B3 : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “Switch off regenertive brake”");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC17 or TC18 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
