...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_17_4_2_PA_Track_Condition_Sound_Horn_in_Sub_Area_D2_and_B3 : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            TraceReport("Action");
            TraceInfo("Drive the train forward with speed = 20km/h");
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “Sound Horn”");
            TraceReport("Expected Result");
            TraceInfo("Verify the following information(1)   DMI displays PL24 symbol in sub-area D2");
            /*
            Test Step 4
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC 35 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
