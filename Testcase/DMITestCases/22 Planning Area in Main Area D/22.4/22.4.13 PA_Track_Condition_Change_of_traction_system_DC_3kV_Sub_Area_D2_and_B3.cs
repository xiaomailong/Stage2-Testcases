    ...
    public class TC_ID_17_4_13_PA_Track_Condition_Change_of_traction_system_DC_3kV_Sub_Area_D2_and_B3 : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “Change of traction system, DC 3 kV”");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC29 or TC30 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
