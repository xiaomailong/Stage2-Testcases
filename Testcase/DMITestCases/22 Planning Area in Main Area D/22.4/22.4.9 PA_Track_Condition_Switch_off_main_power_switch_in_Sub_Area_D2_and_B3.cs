    ...
    public class TC_ID_17_4_9_PA_Track_Condition_Switch_off_main_power_switch_in_Sub_Area_D2_and_B3 : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “Swich off main power switch”");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC06 or TC07 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Enter Anouncement of Track condition “End of Swich off main power switch”");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Stop the train when the TC08 or TC09 symbol displays in sub-area B3");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Driver the train up to 40 km/h");
            TraceReport("Expected Result");
            TraceInfo("The speed pointer is indicated as 20  km/h");
            /*
            Test Step 11
