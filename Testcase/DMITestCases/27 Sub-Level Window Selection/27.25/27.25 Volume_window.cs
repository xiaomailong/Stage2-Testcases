        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            WaitForVerification("Check the following (* indicates sub-areas drawn as one area):" + Environment.NewLine + Environment.NewLine +
                                @"1. DMI displays the Volume window on the right half of the screen with 3 layers in a half-grid array, with the title ‘Volume’." + Environment.NewLine +
                                ...
                                @"6. The Volume windows also displays a data entry window with one data input field, covering areas D, F and G and an ‘Enabled Close’ button (symbol NA11)." + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, "Without changing the volume level, confirm the current value by pressing in the data input field." + Environment.NewLine +
