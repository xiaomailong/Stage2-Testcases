        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            WaitForVerification("Check the following (* indicates sub-areas drawn as one area):" + Environment.NewLine +
                                Environment.NewLine +
                                @"1. DMI displays the Brightness window with 3 layers in a half-grid array with the title ‘Brightness’." +
                                Environment.NewLine +
                                ...
                                @"6. The Brightness windows also displays a data entry window with one data input field, covering areas D, F and G and an ‘Enabled Close’ button (symbol NA11)." +
                                Environment.NewLine +
            ...
            */
            ...
            TraceReport("Expected Result");
            TraceInfo("The Brightness window is closed. DMI displays the Settings window");
            /*
            Test Step 9
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Press ‘Brightness’ button on Settings menu window");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceReport("Expected Result");
            TraceInfo("DMI displays Brightness window.The brightness is still same");
            /*
            Test Step 11
            ...
            */
            DmiActions.ShowInstruction(this,
                "Without changing the luminance, confirm the current value by pressing in the data input field." +
                Environment.NewLine +
