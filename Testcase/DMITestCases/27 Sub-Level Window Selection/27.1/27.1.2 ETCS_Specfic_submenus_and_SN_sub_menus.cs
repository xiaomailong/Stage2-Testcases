...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_22_1_2_Sub_Level_Window : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            TraceReport("Action");
            TraceInfo("Activate cabin and perform start of mission to PLZB STM");
            TraceReport("Expected Result");
            TraceInfo("DMI displays in PLZB STM mode");
            /*
            Test Step 1
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Select Main menu");
            TraceReport("Expected Result");
            TraceInfo("DMI displays Main window The Close buton is enable");
            /*
            Test Step 2
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. The ‘Start’, ‘Maintain Shunting’ and ‘Non-leading’ buttons are displayed disabled." +
                                Environment.NewLine +
                                "3. The ‘Train data’, ‘Level’, ‘Shunting’, and ‘Train running number’ buttons are displayed enabled." +
                                Environment.NewLine +
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Select EOA menu");
            TraceReport("Expected Result");
            TraceInfo("DMI displays EOA window The Close buton is enable");
            /*
            Test Step 4
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Select Data view menu");
            TraceReport("Expected Result");
            TraceInfo("DMI displays Data view window The Close buton is enable");
            /*
            Test Step 6
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the Data view window with the title ‘Data view (1/2)’." +
                                Environment.NewLine +
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Select Special menu");
            TraceReport("Expected Result");
            TraceInfo("DMI displays Special window The Close buton is enable");
            /*
            Test Step 8
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. The ‘Close’ button is displayed enabled." + Environment.NewLine +
                                "3. The ‘Adhesion’ and ‘SR speed distance’ buttons are displayed disabled." +
                                Environment.NewLine +
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Select Settings menu");
            TraceReport("Expected Result");
            TraceInfo("DMI displays Settings window The Close buton is enable");
            /*
            Test Step 10
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. The ‘Language’ button is displayed enabled with symbol SE03." +
                                Environment.NewLine +
                                "3. The ‘Brightness’ button is displayed enabled with symbol SE01." +
                                Environment.NewLine +
                                ...
                                "11. The ‘Time’ button is displayed enabled with a clock symbol." +
                                Environment.NewLine +
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Press National button");
            TraceReport("Expected Result");
            TraceInfo("DMI displays National sub-window The Close buton is enable");
            /*
            Test Step 11
            ...
            */
            ...
            TraceInfo("Press Close button");
            TraceReport("Expected Result");
            TraceInfo("DMI displays the setting window");
            /*
            Test Step 12
            Action: Press Close button
