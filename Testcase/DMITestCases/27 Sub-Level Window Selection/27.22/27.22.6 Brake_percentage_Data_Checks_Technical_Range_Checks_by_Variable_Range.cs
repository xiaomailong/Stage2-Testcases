...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_22_22_6_Brake_percentage_Data_Checks : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            DmiActions.ShowInstruction(this, "Enter ‘10’ for Brake percentage and confirm by pressing in the data input field");
            ...
            */
            DmiActions.ShowInstruction(this, "Enter ‘251’ for Brake percentage and confirm by pressing in the data input field");

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                @"1. The ‘Enter’ button of the data input field displays ‘251’ in black text on a grey background." + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, @"Enter ‘250’ for Brake percentage and confirm by pressing in the data input field");
