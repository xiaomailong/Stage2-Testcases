        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. Objects, text messages and buttons can be displayed in several levels. Within a level they are allocated to areas." + Environment.NewLine +
                                "3. Objects, text messages and buttons in a layer form a window." + Environment.NewLine + 
            ...
            */
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Start’ button pressed, drag it back inside its area");
            ...
            */
            ...
            WaitForVerification("Check the following (* indicates sub-areas drawn as one area):" + Environment.NewLine + Environment.NewLine +
                                ...
                                "16. The following screen areas are in Layer 1: A1, (A2 + A3)*, A4, D, C1, (C2 + C3 + C4)*, C5, C6, C7, C8, C9, E1, E2, E3, E4, (E5-E9)." + Environment.NewLine +
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the ‘Driver ID’ button pressed, without a border." + Environment.NewLine +
                                "2. The ‘Click’ sound is played once.");
            ...
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Driver ID’ button pressed, drag it back inside its area");
            ...
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Level’ button pressed, drag it back inside its area");
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the ‘Train data’ button pressed, without a border." + Environment.NewLine +
                                "2. The ‘Click’ sound is played once.");

            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Train data’ button pressed, drag outside its area");

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the ‘Train data’ button enabled, with a border." + Environment.NewLine +
                                "2. No sound is played.");

            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Train data’ button pressed, drag it back inside its area");
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the ‘Train running number’ button pressed, without a border." + Environment.NewLine +
                                "2. The ‘Click’ sound is played once.");

            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Train running number’ button pressed, drag outside its area");

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the ‘Train running number’ button enabled, with a border." + Environment.NewLine +
                                "2. No sound is played.");

            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Train running number’ button pressed, drag it back inside its area");
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. The ‘Shunting’ button is displayed pressed and then re-displayed enabled." + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Shunting’ button pressed, drag it back inside its area and hold it for 1s," + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Shunting’ button pressed, drag it back inside its area and hold it for at least 2s");
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. DMI displays the ‘Start’, ‘Train data’, ‘Level’, ‘Train running number’, ‘Shunting’ and ‘Maintain shunting’ buttons" + Environment.NewLine +
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI still displays the Main window." + Environment.NewLine +
                                "2. The ‘Maintain shunting’ button is displayed pressed and then re-displayed enabled." + Environment.NewLine +
                                "3. The ‘Click’ sound is played once.");
            ...
            // Repeat Step 10
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Maintain shunting’ button pressed, drag outside its area");
            ...
            // Repeat Step 11
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Maintain shunting’ button pressed, drag it back inside its area and hold it for 1s," + Environment.NewLine +
                                              "then drag outside its area");
            ...
            // Repeat Step 12
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Maintain shunting’ button pressed, drag it back inside its area and hold it for at least 2s");
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI still displays the Main window." + Environment.NewLine +
                                "2. The ‘Exit shunting’ button is displayed pressed and then re-displayed enabled." + Environment.NewLine +
                                "3. The ‘Click’ sound is played once.");
            ...
            // Repeat Step 10
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Exit shunting’ button pressed, drag outside its area");
            ...
            // Repeat Step 11
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Exit shunting’ button pressed, drag it back inside its area and hold it for 1s," + Environment.NewLine +
                                              "then drag outside its area");
            ...
            // Repeat Step 12
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Exit shunting’ button pressed, drag it back inside its area and hold it for at least 2s");
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI still displays the Main window." + Environment.NewLine +
                                "2. The ‘Non-leading’ button is displayed pressed and then re-displayed enabled." + Environment.NewLine +
                                "3. The ‘Click’ sound is played once.");
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. The ‘Non-leading’ button is displayed pressed and then re-displayed enabled, repeatedly, while the button is held." + Environment.NewLine +
                                "2. The ‘Click’ sound is played once." + Environment.NewLine +
            ...
            // Repeat Step 11
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Non-leading’ button pressed, drag it back inside its area and hold it for 1s," + Environment.NewLine +
                                              "then drag outside its area");
            ...
            // Repeat Step 12
            DmiActions.ShowInstruction(this, @"Whilst keeping the ‘Non-leading’ button pressed, drag it back inside its area and hold it for at least 2s");
