...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_22_6_3_1_Wheel_diameter_window : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            TraceReport("Action");
            TraceInfo("Press ‘Wheel diameter’ button");
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Perform action step 2-6 for keypad of the ‘Wheel diameter 2’ input field");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Perform action step 2-6 for keypad of the ‘Accuracy’ input field");
            TraceReport("Expected Result");
            TraceInfo(
                "See the expected results of Step 2 – Step 6 and the following additional information,The pressed key is added in an input field immediately. The cursor is jumped to next position after entered the character immediately");
            /*
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Confirm the value of ‘Accuracy’");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Press ‘Yes’ button and confirm entered data by pressing an input field");
            TraceReport("Expected Result");
            ...
            */
            ...
            TraceInfo("Press ‘Wheel diameter’ button");
            TraceReport("Expected Result");
            TraceInfo("DMI displays Wheel diameter window");
            /*
            Test Step 20
            Action: Press ‘Wheel diameter’ button
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Press and hold the Label area of ‘Wheel diameter 2’ input field");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Slide out the Label part of ‘Wheel diameter 2’ input field");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Slide back into the Label part of ‘Wheel diameter 2’ input field");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Perform action step 21-24 for the Label part of Wheel diameter 1 and Accuracy input field");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            ...
            TraceHeader("TP-" + UniqueIdentifier++);
            TraceReport("Action");
            TraceInfo("Perform action step 21-24 for the Data part of each input field");
            TraceReport("Expected Result");
            TraceInfo(
