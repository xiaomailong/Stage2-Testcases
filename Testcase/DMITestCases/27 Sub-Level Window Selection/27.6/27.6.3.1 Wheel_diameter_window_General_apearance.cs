        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            MakeTestStepHeader(4, UniqueIdentifier++,
                "Perform action step 2-3 for the ‘1’ to ‘9’ buttons.Note: Press the ‘Del’ button to delete an information when entered data is out of input field range is acceptable",
                "See the expected results of Step 2 – Step 3 and the following additional information,The pressed key is added in an input field immediately. The cursor is jumped to next position after entered the character immediately");
            /*
            Test Step 4
            ...
            */
            ...
            MakeTestStepHeader(7, UniqueIdentifier++,
                "Delete the old value and enter the value ‘1000’ for Wheel diameter 1.Then, confirm an entered data by pressing an input field",
            ...
            */
            ...
            MakeTestStepHeader(8, UniqueIdentifier++,
                "Perform action step 2-6 for keypad of the ‘Wheel diameter 2’ input field",
                "See the expected results of Step 2 – Step 6 and the following additional information,The pressed key is added in an input field immediately. The cursor is jumped to next position after entered the character immediately");
            /*
            Test Step 8
            ...
            */
            ...
            MakeTestStepHeader(9, UniqueIdentifier++,
                "Delete the old value and enter the value ‘1000’ for Wheel diameter 2.Then, confirm an entered data by pressing an input field",
            ...
            */
            ...
            MakeTestStepHeader(10, UniqueIdentifier++,
                "Perform action step 2-6 for keypad of the ‘Accuracy’ input field",
                "See the expected results of Step 2 – Step 6 and the following additional information,The pressed key is added in an input field immediately. The cursor is jumped to next position after entered the character immediately");
            /*
            Test Step 10
            ...
            */
            ...
            MakeTestStepHeader(11, UniqueIdentifier++,
                "Delete the old value and enter the value ‘30’ for Accuracy.Then, confirm an entered data by pressing an input field",
            ...
            */
            ...
            MakeTestStepHeader(12, UniqueIdentifier++,
                "Perform the following procedure,Select ‘Wheel diameter 1’ input field.Enter new value for ‘Wheel diameter 1’.Select ‘Accuracy’ input field",
            ...
            */
            ...
            MakeTestStepHeader(13, UniqueIdentifier++, "Confirm the value of ‘Accuracy’",
                "Verify the following information,The state of input field ‘Wheel diameter 1’ is changed to ‘Selected’");
            /*
            Test Step 13
            ...
            */
            ...
            MakeTestStepHeader(14, UniqueIdentifier++,
                "Enter and confirm the new value ‘1000’ for ‘Wheel diameter 1’ value.Press and hold ‘Yes’ button",
            ...
            */
            ...
            MakeTestStepHeader(15, UniqueIdentifier++, "Slide out the ‘Yes’ button",
                "Verify the following information,The border of the input field is shown (state ‘Enabled’) without a sound");
            /*
            Test Step 15
            ...
            */
            ...
            MakeTestStepHeader(16, UniqueIdentifier++, "Slide back into the ‘Yes’ button",
            ...
            */
            ...
            MakeTestStepHeader(17, UniqueIdentifier++, "Release ‘Yes’ button",
            ...
            */
            ...
            MakeTestStepHeader(18, UniqueIdentifier++,
                "Press ‘Yes’ button and confirm entered data by pressing an input field",
            ...
            */
            ...
            MakeTestStepHeader(19, UniqueIdentifier++,
                "Perform the following procedure,Press ‘Wheel diameter’ button.Confirm the current data of all input fields without re-entry.Press ‘Yes button.Press ‘Yes’ button and confirm entered data at Wheel diameter validation window",
                "Verify the following information,The first input field is used to revalidation the Wheel diameter 1.The second input field is used to revalidation the Wheel diameter 2.The third input field is used to revalidation the Accuracy");
            /*
            Test Step 19
            ...
            */
            ...
            MakeTestStepHeader(20, UniqueIdentifier++, "Press ‘Wheel diameter’ button",
            ...
            */
            ...
            MakeTestStepHeader(21, UniqueIdentifier++,
                "Press and hold the Label area of ‘Wheel diameter 2’ input field",
                "Verify the following information,The state of ‘Wheel diameter 2’ input field is changed to ‘Pressed’, the border of button is removed.The state of ‘Wheel diameter 2’ input field remains ‘not selected’. The state of ‘Wheel diameter 1’ input field remains ‘selected’.The sound ‘Click’ is played once");
            /*
            Test Step 21
            ...
            */
            ...
            MakeTestStepHeader(22, UniqueIdentifier++, "Slide out the Label part of ‘Wheel diameter 2’ input field",
                "Verify the following information,The border of ‘Wheel diameter 2’ input field is shown (state ‘Enabled’) without a sound.The state of ‘Wheel diameter 2’ input field remains ‘not selected’. The state of ‘Wheel diameter 1’ input field remains ‘selected’");
            /*
            Test Step 22
            ...
            */
            ...
            MakeTestStepHeader(23, UniqueIdentifier++,
                "Slide back into the Label part of ‘Wheel diameter 2’ input field",
                "Verify the following information,The state of ‘Wheel diameter 2’ input field is changed to ‘Pressed’, the border of button is removed.The state of ‘Wheel diameter 2’ input field remains ‘not selected’. The state of ‘Wheel diameter 1’ input field remains ‘selected’");
            /*
            Test Step 23
            ...
            */
            ...
            MakeTestStepHeader(24, UniqueIdentifier++, "Release the pressed area",
                "Verify the following information,The state of ‘Wheel diameter 2’ input field is changed to selected");
            /*
            Test Step 24
            ...
            */
            ...
            MakeTestStepHeader(25, UniqueIdentifier++,
                "Perform action step 21-24 for the Label part of Wheel diameter 1 and Accuracy input field",
                "Verify the following information,The state of an input field is changed to ‘selected’ when release the pressed area at the Label part of input field");
            /*
            Test Step 25
            ...
            */
            ...
            MakeTestStepHeader(26, UniqueIdentifier++,
                "Perform action step 21-24 for the Data part of each input field",
            ...
            */
            ...
            MakeTestStepHeader(27, UniqueIdentifier++, "Press ‘Close’ button",
                "Verify the following information,Use the log file to confirm that DMI sent out packet [MMI_DRIVER_REQUEST (EVC-101)] with variable MMI_M_REQUEST = 54 (Exit Maintenance).The window is closed and the Maintenance window is displayed");
            /*
            Test Step 27
            ...
            */
            ...
            MakeTestStepHeader(28, UniqueIdentifier++, "End of test", "");
