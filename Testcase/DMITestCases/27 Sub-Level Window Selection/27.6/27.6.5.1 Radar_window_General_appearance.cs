        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                @"1. DMI displays the Radar window with the title ‘Radar’, right aligned." + Environment.NewLine +
                                @"2  The Radar window displays the (enabled) ‘Close’ button, symbol NA11, two data input fields (on page 1), " + Environment.NewLine +
                                @"   a ‘Yes’ button (disabled) with a label ‘Radar entry complete?’ in black on a Dark-grey Background colour with a border in Medium-grey (the same as the input field’s colour)." + Environment.NewLine +
                                @"3. The sensitive area of the ‘Yes’ button includes the label." + Environment.NewLine +
                                @"4. The data input fields are displayed in areas D and F, with a Label Area and a Data Part Area." + Environment.NewLine +
                                 "5. The text in the Label area corresponds to the (current input field) i.e. Radar 1 pulses (1/km)." + Environment.NewLine +
                                 "6. The Label Area is to the left of The Data Area with right-aligned text in grey on a Dark-grey background. The data in the Data Part is aligned to the left." + Environment.NewLine +
                                 "7. There are only 2 input fields displayed in the first page of window." + Environment.NewLine +
                                @"8. The first data input field is displayed ‘Selected’, with the value in black on a Medium-grey background." + Environment.NewLine +
                                 "9. All other input fields are ‘Not selected’ as follows, in grey on a Dark-grey background." +
                                 "10. A numeric keypad is displayed for the data input field ‘Radar 1’, with enabled buttons for the numbers <1> to <9>,  a <Delete> button (symbol NA21), number <0> and the <Decimal_Separator>(disabled)." + Environment.NewLine +
                                 "11. All areas of the window are in Layer 0." + Environment.NewLine +
                                 "12. Echo texts are displayed in areas A, B, C and E in the same order as their related input fields, with a Label Part and a Data Part." + Environment.NewLine +
                                 "13. The echo text Label Part is the same as The Label area of the corresponding data input field." + Environment.NewLine +
                                 "14. The echo text Label part is right-aligned. The echo text Data part is left-aligned." + Environment.NewLine +
                                 "15. Echo texts are in grey." + Environment.NewLine +
                                 "16. A flashing (visible/invisible) underscore is displayed below the value in the input field." + Environment.NewLine +
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "3. The Radar 1 data input field displays the value of the button pressed." + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, @"Delete the old value  for Radar 1 (if any), enter the value ‘20001’ and confirm the entered data by pressing the data input field");
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "3. The Radar 1 data input field is displayed accepted (the value is white on a Dark-grey background." + Environment.NewLine +
                                "4. The Radar 2 data input field (the next field) is displayed selected (the value is black on a Medium-grey background" + Environment.NewLine +
                                "5. The Radar 1 echo text displays the value of the data entered in white." + Environment.NewLine +
                                "6. A flashing underscore (visible/invisible) is displayed after the last character entered." + Environment.NewLine +
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. The button is displayed pressed and immedately re-displayed enabled." + Environment.NewLine +
                                @"2. The ‘Click’ sound is played once." + Environment.NewLine +
                                "3. The Radar 2 data input field displays the value of the button pressed." + Environment.NewLine +
                                "4. A cursor is displayed after the character just added to the data input field.");
            ...
            */
            DmiActions.ShowInstruction(this, @"Delete the old value  for Radar 2 (if any), enter the value ‘20001’ and confirm the entered data by pressing the data input field");

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                @"1. The data input field acts as an ‘Enter’ button." + Environment.NewLine +
                                "2. Data can be entered in the data input field" + Environment.NewLine +
                                "3. The Radar 2 data input field is displayed accepted (the value is white on a Dark-grey background." + Environment.NewLine +
                                "4. The Radar 2 echo text displays the value of the data entered in white." + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, @"Select the Radar 1 data input field and enter a new value for Radar 1, then selected the Radar 2 data input field");

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                @"1. The ‘Yes’ button beneath the label ‘Train data Entry is complete?’ is displayed disabled." + Environment.NewLine +
            ...
            */
            DmiActions.ShowInstruction(this, @"Enter the value ‘20001’ for Radar 2 and confirm by pressing the data input field, then press and hold the ‘Yes’ button");
            ...
            */
            DmiActions.ShowInstruction(this, "Whilst keeping the Radar 2 data input field pressed, drag it out of its area");
            ...
            */
            DmiActions.ShowInstruction(this, "Whilst keeping the Radar 2 data input field pressed, drag it back inside its area");
            ...
            */
            ...
            DmiActions.ShowInstruction(this, "Whilst keeping the Label area of the Radar 1 data input field pressed, drag it out of its area");
            

            // Repeat Step 21 for Radar 1 data input field
            DmiActions.ShowInstruction(this, "Whilst keeping the Label area of the Radar 1 data input field pressed, drag it back inside its area");
            ...
            */
            ...
            DmiActions.ShowInstruction(this, "Whilst keeping the Data area of the Radar 1 data input field pressed, drag it out of its area");
            
            // Repeat Step 21 for Radar 1 data input field Data area
            DmiActions.ShowInstruction(this, "Whilst keeping the Data area of the Radar 1 data input field pressed, drag it back inside its area");
            ...
            DmiActions.ShowInstruction(this, "Whilst keeping the Data area of the Radar 2 data input field pressed, drag it out of its area");

            // Repeat Step 21 for Radar 2 data input field Data area
            DmiActions.ShowInstruction(this, "Whilst keeping the Data area of the Radar 2 data input field pressed, drag it back inside its area");
