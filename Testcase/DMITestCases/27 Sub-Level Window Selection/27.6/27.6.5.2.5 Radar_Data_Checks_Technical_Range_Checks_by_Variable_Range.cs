...
namespace Testcase.DMITestCases
{
    ...
    public class TC_22_6_5_2_5_Radar_Data_Checks : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            TraceInfo("The ‘Radar’ data entry window appears on ETCS-DMI screen instead of the ‘Settings’ menu window");
            /*
            Test Step 1
            ...
            */
            ...
            TraceReport("Action");
            TraceInfo(
                "Enter “20001” (minimum inbound) with the numeric keypad and press the data input field (Accept) in the same screen");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            DmiActions.ShowInstruction(this,
                "On the numeric keypad, enter the value ‘20001’ and confirm the entered data by pressing the data input field");
            ...
            TraceReport("Action");
            TraceInfo(
                "Enter “20000” (outbound) with the numeric keypad and press the data input field (Accept) in the same screen");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            DmiActions.ShowInstruction(this,
                "On the numeric keypad, enter the value ‘20000’ and confirm the entered data by pressing the data input field");

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                @"1. The data input field data area (‘Enter’ button) displays the value ‘20000’ in black on a grey background." +
                                Environment.NewLine +
            ...
            TraceReport("Action");
            TraceInfo(
                "Enter “85534” (maximum inbound) with the numeric keypad and press the data input field (Accept) in the same screen");
            TraceReport("Expected Result");
            TraceInfo(
            ...
            */
            DmiActions.ShowInstruction(this,
                "On the numeric keypad, enter the value ‘85534’ and confirm the entered data by pressing the data input field");
            ...
            */
            ...
            DmiActions.ShowInstruction(this,
                @"Validate the data in the data validation window by pressing in the data input field labelled ‘Yes’");
