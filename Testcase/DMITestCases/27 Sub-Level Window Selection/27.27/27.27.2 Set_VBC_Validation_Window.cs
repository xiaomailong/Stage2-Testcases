        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI displays the Set VBC validation window, with the title ‘Validate set VBC’, right-aligned." +
                                Environment.NewLine +
                                "2. The window contains an enabled Close button (NA11), a data input field and ‘Yes’ and ‘No’ buttons." +
                                Environment.NewLine +
                                ...
                                "5. The (single) data input field only has a data area, which has a blank value." +
                                Environment.NewLine +
                                "6. The data input field has a dedicated keypad containing <Yes> (#8) and <No> (#7) keys." +
                                Environment.NewLine +
                                "7. An echo text with Label, with right-aligned text, and Data, with left-aligned text, parts is displayed." +
                                Environment.NewLine +
                                "8. The echo text displays the value, in white, as input in the Set VBC window." +
                                Environment.NewLine +
            ...
            */
            ...
            MakeTestStepHeader(6, UniqueIdentifier++, "Released the pressed area",
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                ...
                                "2. The disabled buttons are displayed with labels in Dark-grey." +
                                Environment.NewLine +
