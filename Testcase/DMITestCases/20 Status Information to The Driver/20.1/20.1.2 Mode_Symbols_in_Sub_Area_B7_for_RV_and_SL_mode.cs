    ...
    public class TC_15_1_2_ETCS_Mode_Symbols : TestcaseBase
    {
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            MakeTestStepHeader(2, UniqueIdentifier++, "Force the train into RV mode by stopping the train",
                " Verify the following information, Use the log file to confirm that DMI received the EVC - 8 with[MMI_DRIVER_MESSAGE(EVC - 8).MMI_Q_TEXT] = 286 in order to display a symbol ‘ST06’ in sub - area C6");
            /*
            ...
            */
            ...
            MakeTestStepHeader(3, UniqueIdentifier++, "Change the train direction to reverse",
                "Verify the following information,The acknowledgement for Reversing symbol (MO15) is displayed in area C1.Use the log file to confirm that DMI received the EVC-8 with [MMI_DRIVER_MESSAGE (EVC-8).MMI_Q_TEXT] = 262 in order to display the acknowledgement for Reversing symbol");
            /*
            ...
            */
            ...
            MakeTestStepHeader(4, UniqueIdentifier++, "Press the symbol ‘MO15’ in area C1",
                "Verify the following information,The Reversing symbol (M014) is displayed in area B7.");
            /*
