...
namespace Testcase.DMITestCases
{
    ...
    public class TC_ID_6_2_Acknowledgements : TestcaseBase
    {
        public override bool TestcaseEntryPoint()
        {
            ...
            UniqueIdentifier = 20808;
            // Testcase entrypoint
            StartUp();

            // System is powered on. Cabin is activated. Perform SoM until level 1 is selected and confirmed. Main window is closed.
            DmiActions.Complete_SoM_L1_SB(this);

            MakeTestStepHeader(1, UniqueIdentifier++,
                "Use the test script file 6_2_a.xml to send EVC-8 with, MMI_Q_TEXT = 280 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 1",
                "DMI displays the text message ‘Emergency stop’ in sub-area E5 with yellow flashing frame");
            /*
            Test Step 1
            Action: Use the test script file 6_2_a.xml to send EVC-8 with, MMI_Q_TEXT = 280 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 1
            ...
            */
            ...
            MakeTestStepHeader(2, UniqueIdentifier++,
                "(Continue from step 1) Send EVC-8 with, MMI_Q_TEXT = 1 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 1",
                "Verify the following information," +
                "(1) DMI displays the text message 'Acknowledgement' in sub-area E5 with yellow flashing frame");
            /*
            Test Step 2
            Action: (Continue from step 1) Send EVC-8 with, MMI_Q_TEXT = 1 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 1
            ...
            */
            ...
            MakeTestStepHeader(3, UniqueIdentifier++, "Press an acknowledgement in sub-area E5",
                "The acknowledgement is removed, no message displayed on sub-area E5." +
                "(1) Use the log file to confirm that DMI sends out packet [MMI_DRIVER_ACTION (EVC-152)] with the value of variable MMI_M_DRIVER_ACTION refer to sequence below,a)   MMI_M_DRIVER_ACTION = 24 (Ack of Fixed Text information)");
            /*
            Test Step 3
            Action: Press an acknowledgement in sub-area E5
            Expected Result: The acknowledgement is remove, no message display on sub-area E5.
                (1) Use the log file to confirm that DMI sends out packet [MMI_DRIVER_ACTION (EVC-152)] with the value of variable MMI_M_DRIVER_ACTION refer to sequence below,a)   MMI_M_DRIVER_ACTION = 24 (Ack of Fixed Text information)
            Test Step Comment: (1) MMI_gen 11470 (partly: Bit # 24);
            */
            DmiActions.ShowInstruction(this, "Acknowledge by pressing in sub-area E5");

            EVC152_MMIDriverAction.Check_MMI_M_DRIVER_ACTION = EVC152_MMIDriverAction.MMI_M_DRIVER_ACTION.FixedTextInformationAck;

            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. The message in area sub-area E5 is removed.");

            MakeTestStepHeader(4, UniqueIdentifier++,
                "Use the test script file 6_2_b.xml to send EVC-8 with, MMI_Q_TEXT = 1 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 1",
                "DMI displays the text message 'Acknowledgement' in sub-area E5 with yellow flashing frame");
            /*
            Test Step 4
            Action: Use the test script file 6_2_b.xml to send EVC-8 with, MMI_Q_TEXT = 1 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 1
            ...
            */
            ...
            MakeTestStepHeader(5, UniqueIdentifier++,
                "(Continue from step 4) Send EVC-8 with, MMI_Q_TEXT = 260 MMI_Q_TEXT_CRITERIA = 0 MMI_I_TEXT = 1",
            ...
            /*
            Test Step 5
            Action: (Continue from step 4)Send EVC-8 with, MMI_Q_TEXT = 260 MMI_Q_TEXT_CRITERIA = 0 MMI_I_TEXT = 1
            ...
            */
            ...
            MakeTestStepHeader(6, UniqueIdentifier++,
                "Use the test script file 6_2_c.xml to send EVC-8 with, MMI_Q_TEXT = 269 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 2",
                "DMI still displays ST01 symbol in sub-area C9");
            /*
            Test Step 6
            Action: Use the test script file 6_2_c.xml to send EVC-8 with, MMI_Q_TEXT = 269 MMI_Q_TEXT_CRITERIA = 1 MMI_I_TEXT = 2
