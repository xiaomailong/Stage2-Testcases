...
namespace Testcase.DMITestCases
{
    ...
    /// 1.Then drive the train forward.Pass BG1 at 250 m: giving pkt 12, pkt 21 and pkt 27 Pass BG2 at 600 m: V_MAIN = 50 km/h Simulate the communication loss between ETCS Onboard and DMI. Then re-establish the communication again.
    /// 
    /// Used files:
    /// 13_1_4.tdg
    /// </summary>
    public class TC_ID_13_1_4_Brake : TestcaseBase
    {
        ...
        public override bool TestcaseEntryPoint()
        {
            ...
            */
            ...
            /*
            Test Step 3
            Action: Drive the train forward passing BG1 Then drive the train forward with speed = 60 km/h in FS mode
            ...
            */
            ...
            EVC7_MMIEtcsMiscOutSignals.MMI_OBU_TR_O_TRAIN = 25000; // 250 m
