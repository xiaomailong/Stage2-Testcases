...
namespace Testcase.DMITestCases
{
    ...
    /// </summary>
    public class TC_ID_22_5_2_Level_Window : TestcaseBase
    {
        public override bool TestcaseEntryPoint()
        {
            ...
            MakeTestStepHeader(1, UniqueIdentifier++,
                "Use the test script file 22_5_2_a.xml to send EVC-20 with,MMI_N_LEVELS = 2 MMI_Q_LEVEL_NTC_ID[0] = 1 MMI_M_CURRENT_LEVEL[0] = 0 MMI_M_LEVEL_FLAG[0] = 1 MMI_M_INHIBITED_LEVEL[0] = 0 MMI_M_INHIBIT_ENABLE[0] = 1 MMI_M_LEVEL_NTC_ID[0] = 0 MMI_Q_LEVEL_NTC_ID[1] = 1 MMI_M_CURRENT_LEVEL[1]  = 0 MMI_M_LEVEL_FLAG[1] = 1 MMI_M_INHIBITED_LEVEL[1] = 1 MMI_M_INHIBIT_ENABLE[1] = 1 MMI_M_LEVEL_NTC_ID[1] = 2",
            ...
            */
            ...
            EVC104_MMINewDriverData.Check_Entered_MMI_X_DRIVER_ID = "1234";
            ...
            Variables.MMI_M_LEVEL_NTC_ID[] paramEvc20MmiMLevelNtcId =
            {
                ...
                Variables.MMI_M_LEVEL_NTC_ID.CBTC,
            ...
            */
            ...
            WaitForVerification("Check the following:" + Environment.NewLine + Environment.NewLine +
                                "1. DMI has closed the Level window");
        ...
        private void XML_22_5_2(msgType type)
        {
            ...
            {
                case msgType.typea:
                    EVC20_MMISelectLevel.MMI_Q_LEVEL_NTC_ID = new []
                    {
                        Variables.MMI_Q_LEVEL_NTC_ID.ETCS_Level,
                        Variables.MMI_Q_LEVEL_NTC_ID.ETCS_Level
                    };

                    EVC20_MMISelectLevel.MMI_M_CURRENT_LEVEL = new []
                    {
                        Variables.MMI_M_CURRENT_LEVEL.NotLastUsedLevel,
                        Variables.MMI_M_CURRENT_LEVEL.NotLastUsedLevel
                    };

                    EVC20_MMISelectLevel.MMI_M_LEVEL_FLAG = new []
                    {
                        Variables.MMI_M_LEVEL_FLAG.MarkedLevel,
                        Variables.MMI_M_LEVEL_FLAG.MarkedLevel
                    };

                    EVC20_MMISelectLevel.MMI_M_INHIBITED_LEVEL = new []
                    {
                        Variables.MMI_M_INHIBITED_LEVEL.NotInhibited,
                        Variables.MMI_M_INHIBITED_LEVEL.Inhibited
                    };

                    EVC20_MMISelectLevel.MMI_M_INHIBIT_ENABLE = new []
                    {
                        Variables.MMI_M_INHIBIT_ENABLE.AllowedForInhibiting,
                        Variables.MMI_M_INHIBIT_ENABLE.AllowedForInhibiting
                    };

                    EVC20_MMISelectLevel.MMI_M_LEVEL_NTC_ID = new []
                    {
                        Variables.MMI_M_LEVEL_NTC_ID.L0,
                        Variables.MMI_M_LEVEL_NTC_ID.L2
                    };
                ...
                case msgType.typeb:
                    ...
                    EVC20_MMISelectLevel.SendClose();
